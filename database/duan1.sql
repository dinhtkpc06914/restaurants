...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 05, 2023 lúc 02:50 AM
...
(76, 'admin', 18, 'c', '2023-12-04 22:51:33', 5),
(77, 'admin', 18, 'c', '2023-12-04 22:54:48', 5),
...
(2, 26, 2, 30000, 120.000, '2023-12-03 08:56:19', 0, 'admin'),
(3, 26, 0, 30000, 120.000, '2023-12-03 08:56:49', 0, 'admin'),
(4, 24, 0, 120000, 460.000, '2023-12-03 08:59:40', 0, 'admin'),
(5, 26, 0, 30000, 480.000, '2023-12-03 09:34:45', 0, 'admin'),
(6, 14, 3, 25000, 130.000, '2023-12-03 09:37:18', 0, 'admin'),
(7, 26, 4, 30000, 120.000, '2023-12-04 06:26:33', 1, 'admin');
...
(18, 'Salad rau xanh', '100000', 20000.000, 'greek-salad.jpg', 'Salad rau thập cẩm là một món ăn nhẹ, đầy màu sắc và dinh dưỡng, kết hợp giữa nhiều loại rau sống khác nhau. Dưới đây là một mô tả tưởng tượng về món salad này:', 0, '2023-11-29', 96, 10),
(23, 'Salad rong biển trứng cua', '125000', 25000.000, 'salad-rong-bien.jpg', 'Salad rong biển trứng cua là một món ăn nhẹ và đầy dinh dưỡng, kết hợp giữa hương vị biển cả của rong biển và độ thơm ngon của trứng cua. Dưới đây là một mô tả tưởng tượng về món salad này:', 0, '2023-11-29', 11, 10),
...
(25, 'Phô mai dây', '120000', 15000.000, 'pho-mai-day.jpg', '<p><strong>Phô mai dây là một món ăn nhẹ và thú vị, thường được làm từ phô mai mềm và đàn hồi. Được biết đến với hình dạng dạng sợi, phô mai dây có thể được cuộn lại thành các cuộn nhỏ giống như dây, tạo nên một hình thức độc đáo và thú vị.</strong></p>', 0, '2023-11-30', 0, 7),
(26, 'Lườn ngỗng áp chảo', '150000', 30000.000, 'luon-nghong.jpg', '<p>Lườn ngỗng áp chảo là một món ăn sang trọng và đặc sắc, nổi bật với sự kết hợp tinh tế giữa thịt ngỗng tươi ngon và các loại gia vị hảo huyền. Đầu tiên, lườn ngỗng được chuẩn bị một cách cẩn thận</p>', 1, '2023-11-30', 389, 11),
(27, 'Cồi sò xào ngủ sắc', '190000', 15000.000, 'coi-xo-xao.jpg', '<p>Cồi sò xào ngủ sắc là một món hấp dẫn và hương vị độc đáo, đậm đà biểu tượng cho hương vị biển cả. Nhìn chung, món ăn này bắt đầu với những cồi sò tươi ngon, được lựa chọn kỹ lưỡng và làm sạch.</p>', 1, '2023-11-30', 9, 11);
...
--
ALTER TABLE `binh_luan`
  MODIFY `ma_binh_luan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `dat_ban`
  MODIFY `ma_dat_ban` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
-- Các ràng buộc cho bảng `chi-tiet-hoa-don`
--
ALTER TABLE `chi-tiet-hoa-don`
  ADD CONSTRAINT `chi-tiet-hoa-don_ibfk_1` FOREIGN KEY (`ma_hoa_don`) REFERENCES `hoa_don` (`ma_hoa_don`);
...
ALTER TABLE `dat_ban`
  ...
  ADD CONSTRAINT `dat_ban_ibfk_2` FOREIGN KEY (`ma_kh`) REFERENCES `khach_hang` (`ma_kh`);
