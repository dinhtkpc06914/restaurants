                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="ma_kh" id="ma_kh" class="form-control" placeholder="Nhập mã khách hàng...">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" name="mat_khau2" class="form-control" placeholder="Nhập lại mật khẩu..." id="mat_khau2">
                        ...
                        <div class="mb-3 text-center mt-3">
                            ...
                            <a href="index.php?btn_list"><input type="button" style="background-color: #2A3F54;" class="btn text-white" value="Danh sách"></a>
                        </div>
                    </form>
                                </div>
                            </div>
