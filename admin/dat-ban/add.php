                ...
                <form action="index.php" method="POST" enctype="multipart/form-data" id="add_mon_an"
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="ten_mon_an" id="ten_mon_an" class="form-control" placeholder="Nhập tên món ăn...">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input type="number" name="don_gia" id="don_gia" class="form-control"  placeholder="Nhập đơn giá...">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="number" name="giam_gia" id="giam_gia" class="form-control"  placeholder="Nhập giá giảm...">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="file" name="hinh" id="hinh" class="form-control"  placeholder="Chọn ảnh...">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <textarea id="editor" spellcheck="false" name="mo_ta_mon"
                                class="form-control form-control-lg mb-3" id="textareaExample" rows="3"  placeholder="Mô tả món ăn..."></textarea>
