  <style>
        body {
            /* background-image: url(<?= $CONTENT_URL ?>/assets/img/event-private.jpg); */
      ...
      <div class="container">
        ...
        <div class="row m-1 pb-5">
            <form action="<?= $SITE_URL . '/cart/invoice.php' ?>" method="POST" class="m-auto" id="invoice"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <h5 class=" mb-3 pt-3 pb-3 pl-sm-4 shadow-sm text-center text-white"
                            style="margin-top: 5rem; background-color: #cda45e; border-radius:10rem;">Thông tin nhận hàng </h5>
                        <div class="form-group form">
                            ...
                            <input type="text" name="ho_ten" id="ho_ten" class="form-control rounded-pill"
                                value="<?= $ho_ten ?>">
                            <span id="full-name-error-message" class="error text-white"></span>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <span id="dia_chi-error-message" class="error text-white"></span>
                        </div>
                        <div class="form-group">
                            ...
                            <br>
                            <input type="radio" name="phuong_thuc" value="0" checked placeholder=""> <span id="phuong_thuc">Thanh toán khi nhận
                            hàng</span>
                            <br>
                            <input type="radio" name="phuong_thuc" value="1" placeholder=""> <span id="phuong_thuc">Thanh toán VNPAY</span>
                        </div>
                    ...
                    <div class="col-md-8">
                        <h5 class=" mb-3 pt-3 pb-3 pl-sm-4 shadow-sm text-center text-white"  style="margin-top: 5rem; background-color: #cda45e; border-radius:10rem;">
                            CHI TIẾT
                            ĐƠN ĐẶT MÓN</h5>
                        <div class="container">
                            <div class="row m-1 pb-5">
                                        ...
                                        <?php foreach ($_SESSION['cart'] as $item): ?>
                                            <tr>
                                                <td class="text-dark font-weight-bold">
                                                    <?= $item['ten_mon_an'] ?>
                                                    <input type="hidden" name="ma_mon_an" value="<?= $item['ma_mon_an'] ?>">
                                                ...
                                                <td class="pt-1 m-auto">
                                                    <input class="text-center" style="width: 3rem;" type="number"
                                                        class=" sl" name="so_luong" value="<?= $item['sl'] ?>" readonly>
                                                </td>
                                                <td>
                                                    <span class="text-danger font-weight-bold">
                                                        <?= number_format((($item['don_gia']) - ($item['gia_giam'])) * ($item['sl']), 0, ".") ?>
                                                        <input type="hidden" name="gia"
                                                            value=" <?= number_format((($item['don_gia']) - ($item['gia_giam'])) * ($item['sl']), 0, ".") ?>">
                                                    </span> đ
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot id="tongdonhang" class="text-white">
                                ...
                                <div class="text-end">
                                    <button type="submit" name="btn_thanh_toan"
                                        class="btn btn-success btn-block pt-2 pb-2 rounded-pill"  style="background-color: #cda45e;">
                                        Xác nhận đặt Món
                                    </button>
                                </div>
                            </div>
